...
class ThemeProvider extends ChangeNotifier {
  ...
  ThemeData _buildLightTheme() {
    return ThemeData.light().copyWith(
      ...
      textTheme: TextTheme(
        titleLarge: TextStyle(color: Colors.black),  // 메인 타이틀용 스타일
        bodyLarge: TextStyle(color: Colors.black, fontFamily: _fontFamily, fontSize: _fontSize),  // 일반 텍스트용 스타일
        bodyMedium: TextStyle(color: Colors.black, fontFamily: _fontFamily, fontSize: _fontSize),  // 일반 텍스트용 스타일
      ),
    );
  }
  ...
  ThemeData _buildDarkTheme() {
    return ThemeData.dark().copyWith(
      ...
      textTheme: TextTheme(
        titleLarge: TextStyle(color: Colors.white),  // 메인 타이틀용 스타일
        bodyLarge: TextStyle(color: Colors.white, fontFamily: _fontFamily, fontSize: _fontSize),  // 일반 텍스트용 스타일
        bodyMedium: TextStyle(color: Colors.white, fontFamily: _fontFamily, fontSize: _fontSize),  // 일반 텍스트용 스타일
      ),
    );
  }
}
